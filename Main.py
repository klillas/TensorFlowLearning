...
semantic_segmentation.initialize(semantic_segmentation_data_train, semantic_segmentation_data_validation, image_height, image_width, image_channels, 0.001, 5, hyper_param_model_name = "Model01")
